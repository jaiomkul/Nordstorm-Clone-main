async function sortData(x, y) {
  try {
    let res = await fetch(
      `https://nordstrom-backend-production.up.railway.app/combi/sort/price?from=${x}&to=${y}`,
      {
        method: "GET",
        headers: {
...
async function filtertypeData(x) {
  try {
    let res = await fetch(
      `https://nordstrom-backend-production.up.railway.app/combi/sort/type?type=${x}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
async function filterData(x) {
  try {
    let res = await fetch(
      `https://nordstrom-backend-production.up.railway.app/combi/sort/brand?brand=${x}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
async function filterColorData(x) {
  try {
    let res = await fetch(
      `https://nordstrom-backend-production.up.railway.app/combi/sort/color?color=${x}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
async function searchData() {
  try {
    let res = await fetch(
      "https://nordstrom-backend-production.up.railway.app/combi",
      {
        method: "GET",
        headers: {
          Accept: "application/json",
